...
<form id="ProductForm" action="upload.jsp" enctype="multipart/form-data" method="post">
 ...
 <div class="col-md-12">
   <div class="row form-group">
     <div class="col-md-4 form-group"><label>Brand name</label> 
        <input type="text"  id="Brandname" name="Brandname" class="form-control" placeholder="Brandname" value="">
    </div>
                   
                    <div class="col-md-4 form-group"><label>Category name</label> 
                     <input type="text" id="Categoryname" name="Categoryname" class="form-control" placeholder="Category name" value="">
                    ...
                    <div class="col-md-4 form-group"><label>Product name</label> 
                     <input type="text" id="Productname" name="Productname" class="form-control" placeholder="Product name" value="">
                
                   </div>
                   
                   
                 <div class="col-md-4 form-group"><label>Quantity</label> 
                     <input type="text" id="Quantityname" name="Quantityname" class="form-control" placeholder="Quantity" >
